...
public class ListadoProductos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<DTOProductoMarcaProveedorCategoria> lista = controlador.obtenerProductos();
        
        request.setAttribute("lst", lista);
        RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/ListadoProductos.jsp");
