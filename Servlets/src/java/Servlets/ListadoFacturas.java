 ...
 * @author gonza
 */
@WebServlet(name = "ListadoFacturas", urlPatterns = {"/ListadoFacturas"})
public class ListadoFacturas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<DTOObtenerFactura2> lista = controlador.obtenerFactura2();
