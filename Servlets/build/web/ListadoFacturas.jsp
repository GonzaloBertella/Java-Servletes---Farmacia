<%-- 
    Document   : ListadoFactura
    Created on : 31/10/2021, 16:01:50
    Author     : gonza
--%>
...
<html>
    <head>
        ...
        <style>
            body{
                background-image: url("https://statics-diariomedico.uecdn.es/cms/2020-09/balanza-dinero-medicamentos_0.jpg");
            }
        </style>
                ...
                <tbody>
                    <c:forEach items="${requestScope.lst}" var="c">
                        <tr>
                            ...
                            <td> <a class="btn btn-outline-warning" href="ListadoDetallesFacturas?cod_venta=${c.cod_venta}">Detalle</a> </td>
                        </tr>
                    </c:forEach>
                </tbody>
            </table>
