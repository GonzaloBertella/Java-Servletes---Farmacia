<%-- 
    Document   : ListadoReporte5
    Created on : 09/11/2021, 22:47:38
    Author     : gonza
--%>
...
<html>
    <head>
        ...
        <style>
            body{
                background: url("https://mdpajedrez.com.ar/wp-content/uploads/2021/05/ranking-foto.jpg") no-repeat fixed center;
                background-size: 45%;
            }
        </style>
    ...
    <body>
        ...
        <div class="container-fluid col-sm-12  ">
            <h2 style="text-align: center; text-shadow: 2px 2px 2px black; padding-top: 170px">
                Ranking 20 suministros de mayor facturación ordenados en forma decreciente por importe 
                total.
            </h2>
        </div>
