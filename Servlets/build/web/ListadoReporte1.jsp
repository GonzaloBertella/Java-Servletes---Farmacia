<%-- 
    ...
    Created on : 01/11/2021, 22:04:35
    Author     : gonza
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid col-sm-12  ">
            <h1>Consultar por el listado de facturación para un día en particular.</h1>
        </div>


        <form class="container pt-4" id="formulario"  action="ListadoReporte1" method="POST"  style="width: 500px">
