<%-- 
    Document   : Home
    Created on : 09/11/2021, 19:41:59
    Author     : gonza
--%>
...
<html>
    <head>
        ...
        <style>
            body {
                background-image: url("https://cdn-3.expansion.mx/dims4/default/e6faf45/2147483647/strip/true/crop/7680x4320+0+0/resize/1200x675!/format/webp/quality/90/?url=https%3A%2F%2Fcdn-3.expansion.mx%2F6e%2F09%2F7af0848a430392ea7da61a34efa0%2Ffarmacia.jpg");
            }
        </style>  
    </head>
    <body>
        ...
        <c:if test ="${sessionScope.autenticado}">
            ...
            <div class="container-fluid col-sm-12  ">
                <h1 style= "padding-top: 170px">
                    Cadena Farmacéutica
                </h1>
                <h2 style="text-align: center; text-shadow: 2px 2px 2px black; padding-top: 20px">
                    Gonzalo Bertella - 111944 - TEMA 2
                </h2>
                <h3  style="text-align: center; text-shadow: 2px 2px 2px black ; padding-top: 20px">
                    Por favor utilice la barra de navegación para desplazarse por el proyecto.
                </h3>
            </div>
        ...
        <c:if test ="${!sessionScope.autenticado}">
            ...
            <div class="container-fluid col-sm-12  ">
                <h1>Porfavor Ingrese Correctamente los Datos</h1>
            </div>
