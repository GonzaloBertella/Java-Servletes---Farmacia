<%-- 
    Document   : Alta_Factura_Detalle
    Created on : 01/11/2021, 12:15:38
    Author     : gonza
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid col-sm-12  ">
            <h1>Alta de Detalle de Factura</h1>
        </div>
        
        <form class="container pt-4" id="formulario" action="Alta_Factura_Detalle" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-6 mb-3">
                    ...
                    <select  class="form-control" name="cboProducto">
                        <c:forEach items="${requestScope.listaProducto}" var="b">
                            <option value="${b.cod_pro}">
                                ${b.descripcion}
                            </option>
                        </c:forEach>
                    </select>
                ...
                <div class="col-sm-12 col-md-6 col-lg-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="validationCustom01"  name="txtCantidad">
                    <div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="validationCustom01"  name="txtPrecioUnitario">
                    <div>
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-6 mb-3">
                    ...
                    <select  class="form-control" name="cboTipoPago">
                        <c:forEach items="${requestScope.listaTipoPago}" var="b">
                            <option value="${b.cod_tipoPago}">
                                ${b.nom_form_pago}
                            </option>
                        </c:forEach>
                    </select>
