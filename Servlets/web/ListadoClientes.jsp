<%-- 
    ...
    Created on : 31/10/2021, 02:56:32
    Author     : gonza
--%>
...
<html>
    <head>
        ...
        <style>
            body{
                background-image: url("https://www.comunicare.es/wp-content/uploads/2021/02/201110-CABECERA-2880x928-G-Farmacia-F2F-Mad-p.width-1920.jpg");
            }
        </style>
    ...
    <body>
        ...
        <form class="container pt-4" id="formulario" style ="margin-bottom:100px ; width: 770px ; text-align: center ">
