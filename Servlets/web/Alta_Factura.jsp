<%-- 
    Document   : Alta_Factura
    Created on : 11/11/2021, 15:38:21
    Author     : gonza
--%>
...
<html>
    ...
    <body>
        ...
        <form class="container pt-4" id="formulario" action="Alta_Factura" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-6 mb-3">
                    ...
                    <select  class="form-control" name="cboCliente">
                        <c:forEach items="${requestScope.listaCliente}" var="b">
                            <option value="${b.cod_cli}">
                                ${b.nom_cli}
                            </option>
                        </c:forEach>
                    </select>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-6 mb-3">
                    ...
                    <select class="form-control" name="cboEmpleado">
                        <c:forEach items="${requestScope.listaEmpleado}" var="b">
                            <option value="${b.cod_emp}">
                                ${b.nom_emp}
                            </option>
                        </c:forEach>
                    </select>
                ...
                <div class="col-sm-12 col-md-12 col-lg-6 mb-3">
                    ...
                    <select  class="form-control" name="cboSucursal">
                        <c:forEach items="${requestScope.listaSucursal}" var="b">
                            <option value="${b.cod_sucursal}">
                                ${b.nom_sucursal}
                            </option>
                        </c:forEach>
                    </select>
...
<td><input type="submit" value="Registrar"  /></td>
        ...
        <form class="container pt-4" id="formulario" style ="margin-bottom:100px ; width: 1000px  ; text-align: center" > 
            <a  class="btn btn-primary" href="Alta_Factura_Detalle" value="Añadir Producto"  id="registrar"  />Añadir Producto </a>
        ...
        <table class="table table-hover" style =" text-align: center">
            ...
            <tbody>
                <c:forEach items="${sessionScope.lstDetalle}" var="c">
                    <tr>
                        <td>${c.producto.cod_pro}</td>
                        <td>${c.cantidad}</td>
                        <td>${c.precio_unitario}</td>
                        <td>${c.tipoPago.cod_tipoPago}</td>
