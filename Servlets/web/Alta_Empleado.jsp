<%-- 
    ...
    Created on : 10/11/2021, 21:38:34
    Author     : gonza
--%>
...
<html>
    <head>
        ...
        <style>
            body{
                background-image: url("https://elglobal.es/wp-content/uploads/2021/03/colaboracion-1209887887-1-002.jpg");
            }
        </style>
    ...
    <body>
        ...
        <form class="container pt-4" id="formulario" action="Alta_Empleado" method="POST">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="validationCustom04" name="txtDireccion">
                    <div>
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-md-12 col-lg-4 mb-3">
                    <label >Barrio</label>
                    <select  class="form-control" name="cboBarrio">
                        <c:forEach items="${requestScope.listaBarrio}" var="b">
                            <option value="${b.cod_barrio}">
                                ${b.barrio}
                            </option>
                        </c:forEach>
                    </select>
            ...
            <div class="row ">
                ...
                <div class="col-sm-12 col-md-4 col-lg-4 mb-3">
                    <label >Cargo</label>
                    <input type="text" class="form-control" id="validationCustom04" name="txtCargo">
                    <div>
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-md-4 col-lg-4 mb-3">
                    <label >Edad</label>
                    <input type="text" class="form-control" id="validationCustom04" name="txtEdad">
                    <div>
                    </div>
                </div>

                <div class="col-sm-12 col-md-4 col-lg-4mb-3">
                    <label>Telefono</label>
                    <input type="text" class="form-control" id="validationCustom01"  name="txtTelefono">
                    <div>
                    </div>
                </div>
