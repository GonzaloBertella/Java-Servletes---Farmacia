<%-- 
    Document   : ListadoReporte3
    Created on : 09/11/2021, 23:46:57
    Author     : gonza
--%>
...
<html>
    <head>
        ...
        <style>
            body{
                background-image: url("https://s3-us-west-1.amazonaws.com/contentlab.studiod/getty/edf4534fbca7423a8320777722dc7e36.jpg");
            }
        </style>
    ...
    <body>
        ...
        <div class="container-fluid col-sm-12  ">
            <h2 style="text-align: center; text-shadow: 2px 2px 2px black; padding-top: 170px">
                Total de facturación para un rango de fechas, en general para la empresa <br> 
                y discriminando por sucursal.
            </h2>
        </div>


        <form class="container pt-4" id="formulario"  action="ListadoReporte3" method="POST"  style="width: 500px">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-6 mb-3" style="padding-top: 20px">
                    <input type="text" class="form-control" id="validationCustom01"  name="txtFecha2">
                </div>
            </div>
