<%-- 
    Document   : Alta_Proveedor
    Created on : 31/10/2021, 19:20:10
    Author     : gonza
--%>
...
<html>
    <head>
        ...
        <style>
            body{
                background-image: url("https://www.bbva.com/wp-content/uploads/2016/09/Sociedad-entre-RCI-Banque-y-BBVA-Colombia-1920x1194.jpg");
            }
        </style>
    ...
    <body>
        ...
        <form class="container pt-4" id="formulario" action="Alta_Proveedor" method="POST">
            <div class="row">
